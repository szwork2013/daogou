...
//登录
 ...
 $scope.getAddresses = function(){
   ...
   $scope.addAddress = function(defaultAddress){
   	// $scope.firstAddress.user_id = $scope.curUserId;
   	// $scope.firstAddress.state = $scope.firstAddressInput.provinceInfo.name;
   	// $scope.firstAddress.state_code = $scope.firstAddressInput.provinceInfo.code;
   	// $scope.firstAddress.city = $scope.firstAddressInput.cityInfo.name;
   	// $scope.firstAddress.city_code = $scope.firstAddressInput.cityInfo.code;
   	// $scope.firstAddress.district = $scope.firstAddressInput.districtInfo.name;
   	// $scope.firstAddress.district_code = $scope.firstAddressInput.districtInfo.code;
   	// $scope.firstAddress.is_default = defaultAddress;


    // console.log(["$scope.firstAddress",$scope.firstAddress]);
    console.log(["$scope.firstAddressInput.provinceInfo", $scope.firstAddressInput.provinceInfo]);
$scope.curUserId = 18;
   	$http.post(URLPort+"/users/18/shipping-addresses",{
   		"user_id": $scope.curUserId,
...
//根据选择的省查询市
  ...
  $scope.citySelect = function(dataobj1,dataobj2){
   ...
   $scope.deleteAddress = function(){
   		...
   		$http.delete(URLPort+"/users/18/shipping-addresses/18")
   	   	.success(function(){
   	    	console.log("删除地址成功");
   	    	$scope.firstBuyerAddress = true;//隐藏填写第一个地址模块，显示选择地址模块
   	    	$scope.buyeraddress = false;
